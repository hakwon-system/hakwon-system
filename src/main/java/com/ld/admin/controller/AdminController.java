...
public class AdminController {
	...
	public ModelAndView imsi4(@RequestParam("day") String day, @RequestParam("date") String date, @RequestParam("choiceDay") String[] choiceDay, @RequestParam("classId") int[] classId, @RequestParam("bookName") String bookName, @RequestParam("title") String[] title) {
	...
	public ModelAndView calendarDetail(@RequestBody Map<String, Object> param) {
		...
		System.out.println("[request keySet] : " + param.keySet());
		System.out.println("[request idx] : " + param.get("id"));
		System.out.println("[request name] : " + param.get("start"));
		System.out.println("=======================================");
		System.out.println("\n");
	...
	public ModelAndView studentDaily(@RequestParam("id") int id) {
		...
		System.out.println(Collections.singletonList(studentClassListVO.get(0).getBook_name()));
	...
	public String insertDailyOrder(@RequestParam("name") String[] name) {
		for (int i = 0; i < name.length; i++) {
	...
	public String deleteDailyOrder(@RequestParam("id") int id) {
	...
	public String insertClassList(@RequestParam("name") String[] name) {
	...
	public String deleteClassList(@RequestParam("id") int id) {
