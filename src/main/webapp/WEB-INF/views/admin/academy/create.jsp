...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="collapseone" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="academy.mdo">학습센터 정보</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapsesend-1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">목록</h6>
        ...
        <li class="nav-item">
            ...
            <div id="collapsesend-2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">목록</h6>
        ...
        <div id="content">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow mx-1">
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item text-center small text-gray-500" href="adminmessage.mdo">메세지함으로
                                이동</a>
                        </div>
                    </li>
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <form id="form1" name="AcademyVO" method="POST" onsubmit="return onclickOk()"
                          action="./create.mdo">
                        ...
                        <div class="card-body">
                            ...
                            대표 번호 : <input type="text" name="academy_phone1">-<input type="text" name="academy_phone2">-<input
                                type="text" name="academy_phone3"><br><br>
                            우편 번호 : <input type="text" name="academy_postcode" id="sample6_postcode" readonly><input
                                type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br><br>
                            주소 : <input type="text" name="academy_address" id="sample6_address" readonly><br><br>
                            상세 주소 : <input type="text" name="academy_detailaddress" id="sample6_detailAddress"><input
                                type="text" name="academy_extraaddress" id="sample6_extraAddress" placeholder="참고항목"
                                readonly>
                        </div>
                    </form>
                </div>
